...
<!--      <el-form-item label="返费时间" prop="paySchoolDate">-->
<!--        <el-date-picker-->
<!--          v-model="dataForm.returnFeeTime"-->
<!--          type="date"-->
<!--          placeholder="选择日期时间">-->
<!--        </el-date-picker>-->
<!--      </el-form-item>-->
<!--      <el-form-item label="返费时间" prop="paySchoolYear">-->
...
<!--      </el-form-item>-->
    ...
    <el-form-item label="是否欠费 1：是 0：否" prop="isArrearage">
      <el-input v-model="dataForm.isArrearage" placeholder="是否欠费 1：是 0：否" disabled="true"></el-input>
    </el-form-item>
    </el-form>
