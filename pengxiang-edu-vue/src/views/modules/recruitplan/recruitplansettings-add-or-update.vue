<template>
  <el-dialog
    ...
    <el-form-item label="专业" prop="specialized">
      <el-input v-model="dataForm.specialized" placeholder="专业"></el-input>
    </el-form-item>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.specialized = data.recruitPlanSettings.specialized
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'specialized': this.dataForm.specialized,
