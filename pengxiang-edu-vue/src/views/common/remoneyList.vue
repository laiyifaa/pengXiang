<template>
  ...
  <el-table :data="tableData"  border style="width: 100%;; margin-top: 20px;">
    <el-table-column prop="col1" label="序号"></el-table-column>
    <el-table-column prop="col2" label="姓名"></el-table-column>
    <el-table-column prop="col3" label="身份证号"></el-table-column>
    <el-table-column prop="col4" label="年级"></el-table-column>
    <el-table-column prop="col5" label="招生季"></el-table-column>
    <el-table-column prop="col6" label="入学日期"></el-table-column>
