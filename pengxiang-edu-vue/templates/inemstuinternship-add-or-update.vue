<template>
  <el-dialog
    ...
    <el-form-item label="实习类别(认识实习、岗位实习)" prop="internshipType">
      <el-input v-model="dataForm.internshipType" placeholder="实习类别(认识实习、岗位实习)"></el-input>
    </el-form-item>
    ...
    <el-form-item label="实习离校日期" prop="internshipLeaveDate">
      <el-input v-model="dataForm.internshipLeaveDate" placeholder="实习离校日期"></el-input>
    </el-form-item>
    <el-form-item label="预计实习结束日期" prop="expectedEndDate">
      <el-input v-model="dataForm.expectedEndDate" placeholder="预计实习结束日期"></el-input>
    </el-form-item>
    <el-form-item label="实际实习结束日期" prop="actualEndDate">
      <el-input v-model="dataForm.actualEndDate" placeholder="实际实习结束日期"></el-input>
    </el-form-item>
    ...
    <el-form-item label="带队教师" prop="leadTeacher">
      <el-input v-model="dataForm.leadTeacher" placeholder="带队教师"></el-input>
    </el-form-item>
    </el-form>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/generator/inemstuinternship/info/${this.dataForm.id}`),
              method: 'get',
