<template>
  <el-dialog
    ...
    <el-form-item label="应收合计" prop="payMoney">
      <el-input v-model="dataForm.payMoney" placeholder="应收合计"></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/generator/feereturn/info/${this.dataForm.id}`),
              method: 'get',
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.payMoney = data.feeReturn.payMoney
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/generator/feereturn/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
